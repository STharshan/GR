...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Two really positive experiences of this business for my husband and I in the last two months and safe to say we will be coming here for future car issues and MOTs etc!",
    name: "jay swann",
  },
